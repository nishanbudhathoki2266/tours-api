...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmlzaGFuYnVkaGF0aG9raSIsImEiOiJjbGZmNXV6Z3MwMDBnNDZuYjNmcDg5cXU1In0.4t3mFigagsbCghwxmk6B-A';
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            location.reload(true); // the true parameter forces a reload from the server! not from the browser cache
          }
          _context2.next = 10;
          break;
        case 7:
